...
export default function ServiceContactForm({ service, title, description }: ServiceContactFormProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">Primera consulta sin compromiso</p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            {submitStatus === 'error' && (
              ...
              >
                ...
                <span className="text-red-400">Error al enviar. Inténtalo de nuevo.</span>
              </motion.div>
            )}
          </form>
        </motion.div>
